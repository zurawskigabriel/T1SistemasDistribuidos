...
class Dimex:
    def __init__(self, idProcesso: int, processos: dict[int, dict[str, Any]], diretorioSnapshots: str | Path | None = None) -> None:
        self.idProcesso = idProcesso
        self.processos = processos
        self.idsRemotos = [idRemoto for idRemoto in sorted(processos.keys()) if idRemoto != idProcesso]
